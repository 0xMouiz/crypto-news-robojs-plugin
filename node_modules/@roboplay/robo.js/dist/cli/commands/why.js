...
const command = new Command("why").description(
  "Find out why a command, event, permission, or scope is in your Robo.\ne.g. /ping, @ready, %ADMINISTRATOR, +applications.commands"
).arguments("[text]").option("-s --silent", "do not print anything").option("-v --verbose", "print more information for debugging").action(whyAction);
...
async function whyAction(text, options) {
  logger({
