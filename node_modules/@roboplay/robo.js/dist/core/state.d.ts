 ...
 * @returns The value for the given key, or null if the key does not exist.
 */
declare function getState<T = string>(key: string): T | null;
declare function getStateSave(botProcess: ChildProcess | null): Promise<Record<string, unknown>>;
 ...
 * @param options Options for setting the state. (Persisting to disk)
 */
declare function setState<T>(key: string, value: T, options?: SetStateOptions): void;

export { State, clearState, getState, getStateSave, loadState, removeInstances, saveState, setState, state };
