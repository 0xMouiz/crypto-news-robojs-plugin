...
declare const Flashcore: {
     ...
     */
    off: (key: string, callback?: WatcherCallback) => void;
    /**
     ...
     */
    on: (key: string, callback: WatcherCallback) => void;
    /**
     ...
     * @returns {Promise<boolean> | boolean} - Resolves to a boolean indicating whether the operation was successful.
     */
    set: <V_1>(key: string, value: V_1) => Promise<boolean> | boolean;
};
