...
import { AutocompleteInteraction, ApplicationCommandOptionChoiceData, CommandInteraction, InteractionReplyOptions, MessagePayload, ClientOptions, PermissionsString } from 'discord.js';
...
export { Api, ApiEntry, BaseConfig, Command, CommandConfig, CommandEntry, CommandOption, CommandResult, Config, Context, ContextConfig, ContextEntry, Event, EventConfig, FlashcoreAdapter, HandlerRecord, HttpMethod, Manifest, Middleware, MiddlewareData, MiddlewareEntry, MiddlewareResult, Plugin, PluginData, PluginMetaOptions, RoboMessage, RoboReply, RoboRequest, RoboStateMessage, RouteHandler, SageOptions, Scope, SpiritMessage };
