...
```bash
npm install /path/to/crypto-news
```

Replace `/path/to/crypto-news` with the actual path to your plugin's directory. Remember to build your plugin between changes using the `npm run build` command.
